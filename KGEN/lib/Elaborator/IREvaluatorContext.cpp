...
//
// The database itself now lives in KGEN/lib/CocoaKB so the parser can reach it
// too -- a `class` declaration needs encodings and framework attribution long
// before elaboration. Only the operator evaluation stays here.
//===----------------------------------------------------------------------===//
