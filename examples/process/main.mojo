...
# ===----------------------------------------------------------------------=== #
# Modular's process example (mojo/examples/process), carried into this
# fork's collection unmodified: child processes from std.os.Process --
# spawn, wait, poll, interrupt, kill.
