...
# ===----------------------------------------------------------------------=== #
# Modular's grayscale example (max/examples/gpu-functions), carried into
# this fork's collection unmodified: a 2D kernel over image pixels,
# running on the Apple GPU through this fork's AIR backend.
